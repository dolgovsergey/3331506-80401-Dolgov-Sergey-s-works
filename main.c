...
double y_step_size = 0.01;
double x_step_size = 0.01;
...
int main() {
 ...
 //program settings
    ...
    main_arr[0][1] = -12;// Y0 offstt from 0 point
    main_arr[0][2] = -38;// offset Y
    current_pos[1] = -14; //current X position
    current_pos[2] = -39; // current Y position
//ALL measurements in mm


///                0123456789 123456789 12345678
    fill_main_arr("l32.1a188r20l21.5a252l6.6a180l35.6a90l4a180l5a102e");//figure shape 
 ...
 //start cutting 
	 ...
	 sector_left_cutting(-13,-25);// from where to where by X 
//   final_pass(-13,-60);         // from where to where by X 
